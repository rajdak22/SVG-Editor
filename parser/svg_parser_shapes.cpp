...
std::shared_ptr<GraphicsObject> SVGParser::parseCircle(
...
std::shared_ptr<GraphicsObject> SVGParser::parseRectangle(
    const std::string& line) {
...
std::shared_ptr<GraphicsObject> SVGParser::parseHexagon(
    const std::string& line) {
  double cx = std::stod(getAttribute(line, "cx"));
  double cy = std::stod(getAttribute(line, "cy"));
  double r = std::stod(getAttribute(line, "r"));
...
std::shared_ptr<GraphicsObject> SVGParser::parsePolyline(
    const std::string& line) {
