...
class SVGParser {
 ...
 private:
  ...
  static void setPaintAttributes(const std::string& line,
  ...
  static std::shared_ptr<GraphicsObject> parseRectangle(
  ...
  static std::shared_ptr<GraphicsObject> parseRoundedRect(
      const std::string& line);
